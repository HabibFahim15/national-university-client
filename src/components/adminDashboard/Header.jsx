...
const Header = () => {
    return (
        <div className='flex justify-between'>
            ...
            <div>
                <Link className='text-[#ffffff] flex item-center justify-around gap-1 md:gap-2 border rounded-full bg-[#1e33f2] md:text-xl  px-4 py-2 md:px-12 md:py-5 font-semibold'>
